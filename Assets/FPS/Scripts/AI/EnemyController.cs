...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : NetworkBehaviour
    {
        ...
        void Update()
        {
            ...
            Color currentColor = OnHitBodyGradient.Evaluate(timeSinceHit / FlashOnHitDuration);
            ...
            //  Do not allow processing if the DetectionModule reference is missing 
            // or hasn't successfully acquired the ActorsManager reference yet.
            if (DetectionModule == null || Unity.FPS.Game.ActorsManager.Instance == null) return;
        ...
        void OnDamaged(float damage, GameObject damageSource)
        {
            ...
            if (damageSource && !damageSource.GetComponent<EnemyController>())
            {
                ...
                //  Play sound via RPC instead of locally ---
                if (DamageTick && !m_WasDamagedThisFrame)
                {
                    //PlayDamageSoundRpc(transform.position);
                }
        ...
        [Rpc(SendTo.Everyone)]
        void PlayDamageSoundRpc(Vector3 soundPosition)
        {
            if (DamageTick != null)
            {
                AudioUtility.CreateSFX(DamageTick, soundPosition, AudioUtility.AudioGroups.DamageTick, 1.0f);
            }
        }
        ...
        void OnDie()
        {
            ...
            PlayDeathEffectsClientRpc(DeathVfxSpawnPoint.position);

            // tells the game flow manager to handle the enemy destuction
            if (m_EnemyManager != null) m_EnemyManager.UnregisterEnemy(this);
            ...
            if (IsServer) 
            {
                ...
                // For dynamically spawned enemies, true is usually fine.
                // For in-scene placed enemies, use false and then disable/hide.
                GetComponent<NetworkObject>().Despawn(true);
        ...
        [Rpc(SendTo.Everyone)]
        void PlayDeathEffectsClientRpc(Vector3 spawnPos)
        {
