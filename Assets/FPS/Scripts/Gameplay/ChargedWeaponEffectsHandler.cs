...
namespace Unity.FPS.Gameplay
{
    ...
    public class ChargedWeaponEffectsHandler : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            // Cache the weapon controller immediately on startup so audio logic works independently of particles
            ...
            // The charge effect needs its own AudioSources, since it will play on top of the other gun sounds
        ...
        void Update()
        {
            // If the WeaponController failed to setup on Awake, guard against crashes
            ...
            m_DiskOrbitParticle.gameObject.SetActive(m_WeaponController.IsWeaponActive.Value);
