...
namespace Unity.FPS.Game
{
    public class DamageArea : MonoBehaviour
    {
        ...
        public bool InflictDamageInArea(float damage, Vector3 center, LayerMask layers,
            QueryTriggerInteraction interaction, GameObject owner)
        {
            ...
            bool didDamageTarget = false;

            // Create a collection of unique health components that would be damaged in the area of effect
            ...
            foreach (Damageable uniqueDamageable in uniqueDamagedHealths.Values)
            {
                ...
                // If we successfully damaged something, flag it true
                didDamageTarget = true;
            }

            return didDamageTarget;
        }
